...
public class SessionController {
    ...
    public ResponseEntity<List<Session>> getMySessions(@RequestHeader("Authorization") String authorization, Pageable pageable) {
        // 1. Izvuci token
        ...
        Page<Session> sessions = sessionService.getMySessions(userId,pageable);

        return new ResponseEntity<>(sessions.getContent(), HttpStatus.OK);
    }
